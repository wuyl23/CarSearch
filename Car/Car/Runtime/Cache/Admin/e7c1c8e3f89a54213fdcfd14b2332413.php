...
<body>
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('User/index?id='.$vo['id']);?>"><?php echo ($vo["username"]); ?></a></td>
			<td><?php echo ($vo["rechargenum"]); ?></td>
			<td><span><?php echo ($vo["time"]); ?></span></td>
			<td>
				<?php if(($vo["way"]) == "1"): ?><spqn class="ajax-get">支付宝支付</span>
					<?php else: ?>
					<span class="ajax-get">微信支付</span><?php endif; ?>
			</td>
			<td><?php echo ($vo["money"]); ?></td>
      <td>
				<?php if(($vo["pay_status"]) == "1"): ?><span class="ajax-get" style="color:green;">成功</span>
				 <?php else: ?>
				 <span class="ajax-get" style="color:red;">失败</span><?php endif; ?>
			</td>
			<td><a href="<?php echo U('User/remove?id='.$vo['id']);?>" class="confirm ajax-get">删除</a></td>
