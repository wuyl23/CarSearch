...
<body>
	...
	<div class="main-title">
		<h2><?php echo isset($info['id'])?'编辑':'新增';?>类型</h2>
	</div>
	<div class="tab-wrap">
		...
		<div class="tab-content">
			<form action="<?php echo U(Search/update);?>" method="post" class="form-horizontal">
				<!-- 基础 -->
				<div id="tab1" class="tab-pane in tab1">

					<div class="form-item">
						<label class="item-label">
							查询名称<span class="check-tips">（名称不能为空）</span>
						</label>
						<div class="controls">
					...
					<div class="form-item">
						<label class="item-label">查询金额(元)</label>
						<div class="controls">
