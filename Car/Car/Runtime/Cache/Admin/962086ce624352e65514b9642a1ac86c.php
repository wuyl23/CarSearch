...
<body>
	...
	<div class="main-title cf">
		<h2><?php if($_GET['_action'] == 'add'): ?>新增<?php else: ?>编辑<?php endif; ?>广告位</h2>
	</div>
	<!-- 表单 -->
	<form id="form" action="<?php echo addons_url('Advertising://Advertising/update');?>" method="post" class="form-horizontal">
		<!-- 基础文档模型 -->
		<div id="tab1" class="tab-pane in tab1">
			...
			<div class="form-item cf">
				...
				<div class="controls">
		            <label class="radio"><input type="radio" value="1" <?php if(($info['type']) == "1"): ?>checked<?php endif; ?> <?php if($_GET['_action'] == 'add'): ?>checked<?php endif; ?> name="type">单图</label>
		            <label class="radio"><input type="radio" value="2" <?php if(($info['type']) == "2"): ?>checked<?php endif; ?> name="type">多图</label>
		            <label class="radio"><input type="radio" value="3" <?php if(($info['type']) == "3"): ?>checked<?php endif; ?> name="type">文字</label>
		            <label class="radio"><input type="radio" value="4" <?php if(($info['type']) == "4"): ?>checked<?php endif; ?> name="type">代码</label>
				</div>
			</div>
			<div class="form-item cf">
				<label class="item-label">广告位宽度<span class="check-tips">（广告在前端展示的宽度）</span></label>
				<div class="controls">
					<input type="text" class="text input-large" name="width" value="<?php echo ($info["width"]); ?>">
				</div>
			</div>
			<div class="form-item cf">
				<label class="item-label">广告位高度<span class="check-tips">（广告在前端展示的高度）</span></label>
				<div class="controls">
					<input type="text" class="text input-large" name="height" value="<?php echo ($info["height"]); ?>">
				</div>
			</div>
		</div>
