...
<body>
	...
	<div class="main-title">
		<h2><?php echo isset($info['id'])?'编辑':'新增';?>优惠</h2>
	</div>
	<div class="tab-wrap">
		...
		<div class="tab-content">
			<form action="<?php echo U(Fcoupon/edit);?>" method="post" class="form-horizontal">
				<!-- 基础 -->
				<div id="tab1" class="tab-pane in tab1">

					<div class="form-item">
						<label class="item-label">
							优惠名称<span class="check-tips">（名称不能为空）</span>
						</label>
						<div class="controls">
					...
					<div class="form-item">
						<label class="item-label">优惠金额(元)</label>
						<div class="controls">
					...
					<div class = "form-item">
                <label class="item-label">最低消费</label>
								<div>
									<input type="text" name="lownum" class="text input-large" value="<?php echo ((isset($info["lownum"]) && ($info["lownum"] !== ""))?($info["lownum"]):''); ?>">
								</div>
					</div>
					<div class="form-item cf">
						<label class="item-label">开始时间</label>
						<div class="controls">
							<input type="text" name="starttime" class="text input-large time" value="<?php echo ($info["starttime"]); ?>" placeholder="请选择日期">
						</div>
					</div>
					<div class="form-item cf">
						<label class="item-label">结束时间</label>
						<div class="controls">
							<input type="text" name="endtime" class="text input-large time"  value="<?php echo ($info["endtime"]); ?>" placeholder="请选择日期">
						</div>
					</div>
				<div class="controls">
					...
					<div class="form-item">
						...
						<div class="controls">
							<input type="text" id="code" name="code" class="text input-large" value="<?php echo ((isset($info["code"]) && ($info["code"] !== ""))?($info["code"]):''); ?>"><a class="btn btn-sm btn-info" href="javascript:vod(0);" onclick="getcode();">获取</a>
						</div>
					</div>
				...
				<div id="tab2" class="tab-pane tab2">
					<div class="form-item">
						...
						<div class="controls">
							<input type="text" name="linkid" class="text input-large" value="<?php echo ((isset($info["linkid"]) && ($info["linkid"] !== ""))?($info["linkid"]):''); ?>">
						</div>
					</div>
			...
			function getcode(){
			  ...
			  $.ajax({
			type:'post',
			url:'<?php echo U("Fcoupon/makecode");?>', //发送数据的地址//
			data:{id:""},
			dataType: "json",
