...
<body>
	...
	<div class="cf">
		<div class="fl">
            ...
            <!-- <button class="btn ajax-post confirm" url="<?php echo U('User/delete?id='.$vo[uid]);?>" target-form="ids">删 除</button> -->
        </div>

        <!-- 高级搜索 -->
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="username" class="search-input" value="<?php echo I('username');?>" placeholder="请输入用户昵称或者ID">
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<!-- <td><img src="<?php echo (get_cover($vo["img"],'path')); ?>"  width="50" height="50"/></td> -->
			...
			<td><?php if(($vo["status"]) == "1"): ?><a href="<?php echo U('Member/changeStatus?method=forbidUser&id='.$vo['uid']);?>" class="ajax-get">禁用</a>
				<?php else: ?>
				<a href="<?php echo U('Member/changeStatus?method=resumeUser&id='.$vo['uid']);?>" class="ajax-get">启用</a><?php endif; ?>
				<a href="<?php echo U('AuthManager/group?id='.$vo['uid']);?>" class="authorize">授权</a>
                <a href="<?php echo U('Member/delete?id='.$vo['uid']);?>" class="confirm ajax-get">删除</a>
                </td>
	...
	<script src="/Car/Public/static/thinkbox/jquery.thinkbox.js"></script>
